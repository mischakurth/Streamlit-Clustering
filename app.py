...
st.set_page_config(page_title="Clustering Visualizer (Debug)", layout="wide")

try:
    st.title("Clustering Algorithmen Visualisierung (Debug Mode)")
    ...
    if data_source == "Generieren":
        ...
        if st.sidebar.button("Neue Daten generieren"):
            st.write("DEBUG: Generiere Daten...")
            try:
